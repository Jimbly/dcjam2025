...
delete for_display.space;
delete for_display.npcs;
delete for_display.hero;
delete for_display.critters;
delete for_display.station;
delete for_display.ship;
delete for_display.moon;
delete for_display.whitebox;
